...
const NUMB_PARTICLE_PER_BULLET = 25;
class particle{
...
class bullet{
    constructor(fireworks){
        ...
        this.particles = [];
        //create 1 particle
        let bulletDeg = Math.PI *2 /NUMB_PARTICLE_PER_BULLET;
        for (let i =0; i <NUMB_PARTICLE_PER_BULLET; i++){
...
class fireworks{
    ...
    clearScreen(){
        ...
        this.ctx.fillStyle = "red";
        this.ctx.textAlign = "center";
        this.ctx.fillText("HAPPY NEW YEAR", WIDTH/2, HEIGHT/2);
    }
    draw(){
        this.clearScreen();
